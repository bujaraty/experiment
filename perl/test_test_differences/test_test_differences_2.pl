...
print "purpose : to see how different diff style in Test::Differences produce the comparison with good result\n";

my $my_result = "/home/jessada/development/experiment/perl/test_test_differences/good_result";
