...
#
#print "*************** List of arguments passed to the script initially ***************\n";
#foreach my $k  (0.. @ARGV-1) {
#    printf "arg-%02d:\t%s\n", $k,$ARGV[$k];
#}
#
#print "*********************** Value of arguments after parsing ***********************\n";
#
#my $a = 0;
#my $b = 0;
#my $i = 0;
...
#my $def = 0;
#
#GetOptions ('a:i' => \$a, 'b' => \$b, 'i:i' => \$i, 'd' => \$d, 'e:i' => \$e, 'f' => \$f, 'def' => \$def) or die "Exception : $!";
#
#print "a : $a\n";
#print "b : $b\n";
#print "i : $i\n";
...
#print "def : $def\n";
#
#print "*********************** List of arguments after parsing ************************\n";
#foreach my $k  (0.. @ARGV-1) {
#    printf "arg-%02d:\t%s\n", $k,$ARGV[$k];
#}
#
...
#my $my_input;
#if ( -t STDIN ) {
#    open $my_input, "<", $ARGV[0] or die $!;
#}
#else {
#    open $my_input, "<&STDIN" or die "Couldn't dup STDIN : $!";
#}
#
